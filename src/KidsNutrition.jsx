...
const QUICK_FOODS = [
  ...
  { name: "Banana", cal: 105, protein: 1, icon: "\u{1F34C}" },
  { name: "PB&J Sandwich", cal: 350, protein: 12, icon: "\u{1F96A}" },
  { name: "Cheese Stick", cal: 80, protein: 7, icon: "\u{1F9C0}" },
  { name: "Yogurt", cal: 100, protein: 5, icon: "\u{1FAD9}" },
  { name: "Chicken Nuggets (6)", cal: 280, protein: 14, icon: "\u{1F357}" },
  { name: "Mac & Cheese", cal: 350, protein: 12, icon: "\u{1F9C8}" },
  { name: "Grilled Cheese", cal: 370, protein: 13, icon: "\u{1F96A}" },
  { name: "Pizza Slice", cal: 270, protein: 12, icon: "\u{1F355}" },
  { name: "Scrambled Eggs (2)", cal: 180, protein: 12, icon: "\u{1F373}" },
  { name: "Goldfish Crackers", cal: 140, protein: 3, icon: "\u{1F41F}" },
  { name: "Fruit Snacks", cal: 80, protein: 0, icon: "\u{1F36C}" },
  { name: "Granola Bar", cal: 140, protein: 3, icon: "\u{1F36B}" },
  { name: "Baby Carrots", cal: 35, protein: 1, icon: "\u{1F955}" },
  { name: "Chocolate Milk", cal: 190, protein: 8, icon: "\u{1F36B}" },
];
  ...
  return (
    <div className="kn-app">
      ...
      <div className="kn-section">
        ...
        >
          <span className="kn-milk-icon">{"\u{1F95B}"}</span>
